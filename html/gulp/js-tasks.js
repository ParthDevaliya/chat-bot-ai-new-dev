...
// trueShine js move task
gulp.task('js:move-trueShine', () => {
  const obj = gulpHelper.find(paths, 'default')
  return gulpHelper.uglify(['src/assets/js/trueShine-script/*.js'], obj.dir)
})

// Main js move task
gulp.task('js:move', gulp.series(jsMoveTask(), 'js:move-trueShine'));
